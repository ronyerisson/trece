...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trece-ronyerisson.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trece-ronyerisson.tangrama.com.br:
      ansible_user: root
      host: trece-ronyerisson
      hostname: trece-ronyerisson.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trece-ronyerisson.tangrama.com.br.yml` to the remote server with:
