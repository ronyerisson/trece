...
2. Go to your repository at [ronyerisson/trece](https://github.com/ronyerisson/trece).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `trece-ronyerisson.tangrama.com.br` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | trece-ronyerisson.tangrama.com.br | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | trece-ronyerisson.tangrama.com.br |
...
- [Backend Tests Workflow](https://github.com/ronyerisson/trece/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/ronyerisson/trece/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/ronyerisson/trece-backend`) and Frontend (`ghcr.io/ronyerisson/trece-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of trece-ronyerisson.tangrama.com.br](https://github.com/ronyerisson/trece/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/trece-ronyerisson.tangrama.com.br.yml` stack.
